...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('assets') }}/welcomepage/img/brand/favicon.ico" type="image/png">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('assets') }}/welcomepage/lib/all.min.css">
    <!-- Quick CSS -->
    <link rel="stylesheet" href="{{ asset('assets') }}/welcomepage/css/quick-website.css" id="stylesheet">
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            ...
            {{-- <a class="navbar-brand" href="index.html">
                <img alt="Image placeholder" src="{{asset('assets')}}/welcomepage/img/brand/dark.svg" id="navbar-logo">
            </a> --}}
            <!-- Toggler -->
                ...
                <div class="col-12 col-md-5 col-lg-6 order-md-2 text-center">
                    ...
                    <figure class="w-100">
                        <img alt="Image placeholder"
                            src="{{ asset('assets') }}/welcomepage/img/svg/illustrations/illustration-3.svg"
    ...
    <!-- Core JS  -->
    <script src="{{ asset('assets') }}/welcomepage/lib/jquery.min.js"></script>
    <script src="{{ asset('assets') }}/welcomepage/lib/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('assets') }}/welcomepage/lib/svg-injector.min.js"></script>
    <script src="{{ asset('assets') }}/welcomepage/lib/feather.min.js"></script>
    <!-- Quick JS -->
    <script src="{{ asset('assets') }}/welcomepage/js/quick-website.js"></script>
    <!-- Feather Icons -->
    <script>
        feather.replace({
            'width': '1em',
